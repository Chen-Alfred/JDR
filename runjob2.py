...
default_run_time = random.randint(3, 10) #3
...
if __name__ == '__main__':
  ...
  sql = f"insert into ctrl.job_exec_log2 values ('{job_name}', '{plan_dt}'::timestamp, '{status}', '{act_sdt}'::timestamp, null, null)"
  cursor.execute(sql)
  conn.commit()
  ...
  sql = f"update ctrl.job_exec_log2 set status2 = '{status}', act_edt2 = '{act_edt}'::timestamp, data_num2 = {data_num} where job_name2 = '{job_name}' and plan_dt2 = '{plan_dt}'::timestamp and act_sdt2 = '{act_sdt}'::timestamp"
